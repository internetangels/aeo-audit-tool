...
def run_audit(url):
    # Simulated AEO audit results
    results = {
        "Home Page Readability": ("🟡", "Average", "Simplify language and shorten paragraphs."),
        "Service Page Keywords": ("🔴", "Missing", "Include clear service names like 'car repairs' and 'mechanic'."),
        "Local Relevance": ("🟢", "Strong", "Well-targeted to Upwey area with location mentions."),
        "Mobile Friendliness": ("🟢", "Pass", "Site is responsive."),
        "AI Tone of Voice": ("🟡", "Mixed", "Adjust content to 7th-grade level, conversational tone."),
        "Testimonials & Reviews": ("🔴", "Weak", "Add testimonials, star ratings, and review links."),
        "Service-in-City Pages": ("🔴", "Missing", "Create pages like 'Mechanic in Upwey', 'Car Repairs Belgrave'."),
        "FAQs & Case Studies": ("🟡", "Some", "Expand your FAQ section and add 1–2 case studies."),
    }
    return results
